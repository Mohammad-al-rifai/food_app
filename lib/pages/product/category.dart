...
class _CategoryState extends State<Category> {
  var myarr_category=[
    {"cat_id":"1","cat_name":"مأكولات بحرية","cat_image":"images/category/cat1.png"},
    {"cat_id":"2","cat_name":"مشاوي","cat_image":"images/category/cat2.png"},
    {"cat_id":"3","cat_name":"مقبلات","cat_image":"images/category/cat3.png"},
    {"cat_id":"4","cat_name":"وجبات سريعة","cat_image":"images/category/cat4.png"},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("قائمة المأكولات",style: TextStyle(fontSize: 18,color: Colors.black),),
